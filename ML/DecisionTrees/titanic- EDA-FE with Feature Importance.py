# -*- coding: utf-8 -*-
"""
Created on Fri May 17 08:30:58 2019
...
#Add column -Survived as the train data has that extra column so that it will be for the concatenation
